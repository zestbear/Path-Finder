...
public class ControlPanel extends JPanel {
	...
	private final JButton stopButton = new JButton("멈춤");
	private final JButton clearMapButton = new JButton("맵 초기화");
	private final JButton generateMapButton = new JButton("맵 생성");
	private final JButton applyCellSizeButton = new JButton("적용");
	private final JButton applyAnimationMsButton = new JButton("적용");
	...
	public ControlPanel(Parameters aParameters) {
		...
		modesPanel.setBorder(BorderFactory.createTitledBorder("모드"));
		...
		mapGeneratingPanel.add(new JLabel("장애물 비율 설정 [%]:"));
		...
		animationCtrlPanel.add(new JLabel("진행 속도 조정 (ms):"));
		...
		mapSettingPanel.add(new JLabel( "픽셀 크기 조정 (pxl):"));
